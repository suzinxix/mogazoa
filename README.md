...
- 첫 로딩 시간은 사용자에게 큰 영향을 준다. 느린 로딩 시간은 사용자의 이탈률을 높이고 부정적인 사용자 경험을 유발 할 수 있음<br/>
- 메인 페이지에서 불러오는 데이터는 실시간으로 자주 바뀌지 않는 데이터라고 판단<br/>
- 이러한 특성에 맞춘 서버 컴포넌트 선택하여 초기 로딩 속도를 크게 향상시켰다.
...
- 상품에 대한 정보를 확인할 수 있습니다. (이미지, 이름, 카테고리 등) <br/>
- 상품 상세 화면 링크를 카카오톡으로 공유하거나 클립보드에 복사할 수 있습니다. <br/>
